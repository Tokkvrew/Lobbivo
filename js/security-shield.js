...
const SecurityShield = {
  ...
  profanityWordRoots: [
    // Еб / ёб / эб (с русскими приставками и суффиксами: заебал, съебись, выебон, подъеб, наебалово, проеб, разъеб, отъебись, въебал, доебался, переебал, уебок, поебать, приебался, долбоеб и др.)
    /^(?:(?:вы|до|за|на|по|пере|при|про|у|недо|само|съ|въ|подъ|отъ|разъ|объ|изъ|взъ)[еёэ]б.*|[еёэ]б[аеиоуыйлнщцчк].*|[еёэ]бл.*|[еёэ]б[оу]т.*|[еёэ]бну.*|[еёэ]б[оыа].*|долб[оа][еёэ]б.*)$/i,
  ...
  profanityWhitelist: new Set([
    ...
    'потребность', 'потребности', 'потребитель', 'потребление', 'употреблять', 'употребление', 'употребил', 'употребить', 'употребляет',
    'серебро', 'серебряный', 'серебряная', 'серебряное',
    'мебель', 'мебели', 'мебельный',
    'лебедь', 'лебедя', 'лебеди',
    'дебет', 'дебетовый', 'дебетовая', 'дебют', 'дебютный',
    'хлеб', 'хлеба', 'хлебу', 'хлебом', 'хлебе', 'хлебный', 'хлебница',
    'стебель', 'стебля', 'стебли', 'стеблей',
    'щебет', 'щебетать', 'щебечет',
    'гребень', 'гребешок', 'гребля', 'гребли', 'загребать', 'выгребать', 'погреб', 'гребец',
    'небоскреб', 'небоскреба', 'небоскребы',
    'победа', 'победил', 'победитель', 'победить',
    'пробег', 'пробежка', 'пробежал', 'забег', 'забежал', 'набег', 'набежал', 'убежал', 'убежище',
